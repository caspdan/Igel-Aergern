...
public class Board3 {
    ...
    public void placeToken(int row, int col, char color) {
        Cell3 cell=board[row][col];
        Igel3 token=new Igel3(color);
        cell.addToken(token);
        board[row][col]=cell;
    }
     ...
     * @return
     */
    public boolean canMoveSideways(int row, int col, Player3 player) {
    ...
    public void moveSideways(int row, int col, int dir) {
        if (dir==-1){
            Igel3 popped=board[row][col].popToken();
    ...
    public void moveForward(int row, int col) {
        Igel3 player=board[row][col].popToken();
        col++;
     ...
     */
    public boolean isWinner(Player3 player) {
     ...
     * @return
     */
    public boolean isPlayerAt(int row, int col, Player3 player) {
     ...
     * @return
     */
    public boolean isPlayerTop(int row, int col, Player3 player) {
        if (board[row][col].isEmpty()){
            return false;
        }
        else{
     ...
     * @return
     */
    private int countColumn(Player3 player){
        int counter=0;
        for (int r=0; r<ROWS; r++){
